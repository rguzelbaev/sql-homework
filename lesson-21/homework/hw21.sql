...
8. % change compared to next sale
SELECT 
...
9. Ratio of current / previous (per product)
SELECT 
    ProductName, SaleDate, SaleAmount,
...
SELECT 
    SaleDate, ProductName, SaleAmount,
...
20. Average salary per department (no GROUP BY)
SELECT 
    Department,
    AVG(Salary) OVER (PARTITION BY Department) AS AvgSalary
FROM Employees1;

21. Salary – department average
SELECT 
    Name, Department, Salary,
...
23. Sum of salaries of last 3 hired
SELECT 
